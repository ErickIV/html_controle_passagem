...
public class ServletVerificarStatus extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        out.println("<html><head><title>Servlet Verificar Status</title></head><body>");
        out.println("<h1>Servlet Verificar Status</h1>");
